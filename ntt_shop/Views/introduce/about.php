		...
		<div class="row">
			<div class="main-padding section-padding-top clearfix">
				<div class="col-sm-12 col-md-5">
					<div class="about-img">
						<img src="public/img/about/unnamed.jpg" alt="" />
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="about-text">
						<div class="about-author">
							<h4>Cửa hàng Điện thoại, Smartwatch, Phụ kiện.</h4>
						</div>
						<h5>Cửa hàng chúng tôi với:</h5>
						<ol>
							<li>Chế độ trả góp ưu đãi!</li>
							<li>Chất lượng sản phẩm luôn đi đầu trong khu vực!</li>
							<li>Giá cả sản phẩm hợp lý, chế độ bảo hành lâu dài!</li>
